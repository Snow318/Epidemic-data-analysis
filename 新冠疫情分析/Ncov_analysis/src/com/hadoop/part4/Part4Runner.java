...
public class Part4Runner {
    ...
    public static String tableName = "suspect";
//    public static String [] fields = {"name","rating","url","author","publisher","publish_date","price","commentNum","tag"};
    ...
    public static void main(String[] args) throws Exception{
    	...
    	job.setJarByClass(Part4Runner.class);
        job.setMapOutputValueClass(IntWritable.class);
        job.setMapOutputKeyClass(Text.class);
        job.setMapperClass(Part4Mapper.class);
        job.setReducerClass(Part4Reduce.class); 
